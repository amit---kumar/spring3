package com.amit.oauthservice.config;
...
public class ProjectSecurityConfig {
    ...
    public RegisteredClientRepository registeredClientRepository() {
        RegisteredClient clientCredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)// this is for basic auth
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_POST)// this is for request body
